...
import (
	...
	cfg "code.cloudfoundry.org/routing-release/gorouter/config"
	"code.cloudfoundry.org/routing-release/gorouter/errorwriter"
	sharedfakes "code.cloudfoundry.org/routing-release/gorouter/fakes"
	"code.cloudfoundry.org/routing-release/gorouter/handlers"
	"code.cloudfoundry.org/routing-release/gorouter/logger"
	"code.cloudfoundry.org/routing-release/gorouter/mbus"
	"code.cloudfoundry.org/routing-release/gorouter/metrics"
	fakeMetrics "code.cloudfoundry.org/routing-release/gorouter/metrics/fakes"
	"code.cloudfoundry.org/routing-release/gorouter/proxy"
	rregistry "code.cloudfoundry.org/routing-release/gorouter/registry"
	...
	testcommon "code.cloudfoundry.org/routing-release/gorouter/test/common"
	"code.cloudfoundry.org/routing-release/gorouter/test_util"
	vvarz "code.cloudfoundry.org/routing-release/gorouter/varz"
