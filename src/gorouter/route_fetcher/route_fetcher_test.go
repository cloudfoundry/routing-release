...
import (
	...
	testRegistry "code.cloudfoundry.org/routing-release/gorouter/registry/fakes"
	...
	fake_routing_api "code.cloudfoundry.org/routing-release/routing-api/fake_routing_api"
