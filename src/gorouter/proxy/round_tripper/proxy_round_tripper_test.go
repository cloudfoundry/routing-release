...
import (
	...
	errorClassifierFakes "code.cloudfoundry.org/routing-release/gorouter/proxy/fails/fakes"
	"code.cloudfoundry.org/routing-release/gorouter/proxy/handler"
	"code.cloudfoundry.org/routing-release/gorouter/proxy/round_tripper"
	roundtripperfakes "code.cloudfoundry.org/routing-release/gorouter/proxy/round_tripper/fakes"
