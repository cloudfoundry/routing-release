...
require (
	code.cloudfoundry.org/diego-logging-client v0.0.0-20240705175210-f205aacaea3c // indirect
	code.cloudfoundry.org/durationjson v0.0.0-20240705175208-6880c3129de7 // indirect
