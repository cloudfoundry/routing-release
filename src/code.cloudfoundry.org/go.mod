...
require (
	code.cloudfoundry.org/diego-logging-client v0.0.0-20240526171204-4928a34fc1a0 // indirect
	code.cloudfoundry.org/durationjson v0.0.0-20240526171154-48413eb7953b // indirect
