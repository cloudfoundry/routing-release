...
require (
	...
	code.cloudfoundry.org/go-metric-registry v0.0.0-20230620185237-7a6da10a7396
...
require (
	...
	code.cloudfoundry.org/go-diodes v0.0.0-20230620185730-2f3f1b7d94bb // indirect
