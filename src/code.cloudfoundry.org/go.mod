...
require (
	code.cloudfoundry.org/diego-logging-client v0.0.0-20240806182234-7c29d82f3f8d // indirect
	code.cloudfoundry.org/durationjson v0.0.0-20240806182325-1a051275a0de // indirect
